...
class SignalRuleDataLoaderTest {
    ...
    void loadsBundledRulesWithoutExplicitType() {
        ...
        prepared.put(MOOD_RULE_ID, readJson("/data/petsplus/ai_signal_rules/mood_blend.json"));
        prepared.put(NATURE_RULE_ID, readJson("/data/petsplus/ai_signal_rules/nature.json"));
