    ...
    public enum EnvironmentTag {
        ...
        private static boolean matches(EnvironmentTag tag, PetBreedEvent.BirthContext.Environment env) {
            return switch (tag) {
                ...
                case SUBMERGED -> env.fullySubmerged();
                case LAVA -> env.nearLavaOrMagma();
                case POWDER_SNOW -> env.nearPowderSnow();
                case MUDDY -> env.nearMudOrMangrove();
                case STRUCTURE -> env.nearMajorStructure();
                case ARCHAEOLOGY -> env.hasArchaeologySite();
                case TRIAL -> env.nearTrialChamber();
                ...
                case DEEP_DARK -> env.deepDarkBiome();
                case MUSHROOM -> env.mushroomFieldsBiome();
                case OCEAN -> env.oceanBiome();
                case SWAMP -> env.swampBiome();
                case SNOWY -> env.snowyPrecipitation();
