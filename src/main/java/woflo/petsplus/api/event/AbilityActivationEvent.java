...
public final class AbilityActivationEvent {
    ...
    public static final class Context {
        ...
        /**
         * @return current activation phase, allowing listeners to distinguish between
         * {@link Phase#PRE} and {@link Phase#POST} callbacks.
         */
        ...
        /**
         * Internal hook used to advance the lifecycle phase before dispatching to
         * listeners.
         */
